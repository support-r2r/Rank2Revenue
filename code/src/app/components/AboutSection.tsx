...
const AboutSection = () => {
  return (
    <section className="relative py-32 bg-[#FAF3EB] text-[#B8524A]">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center md:text-left">
          <span className="inline-block px-6 py-2 text-sm font-semibold border rounded-full border-[#B8524A] mb-6">
            OUR AGENCY
          </span>
          ...
          <div className="flex items-center max-w-3xl">
            {/* Standout Line */}
            <span className="block w-96 h-1 bg-[#B8524A] mr-96"></span>
            <p className="text-lg md:text-xl text-[#B8524A]">
