...
const IndustriesServed: React.FC = () => (
  <section className="bg-white py-24 px-4 lg:px-16"> 
    <div className="container mx-auto max-w-[1300px]">
      <h1 className="text-center text-5xl pb-12 text-black">Industries We Serve</h1>
...
const IndustryCard: React.FC<IndustryCardProps> = ({ title, imageUrl }) => (
  <div className="relative group h-48 flex flex-col rounded-xl bg-white text-gray-700 shadow-md">
    <a href="#" className="block">
      <div className="h-28">
        <div className="absolute -top-20 lg:top-[-10%] left-[5%] z-40 group-hover:top-[-40%] group-hover:opacity-[0.9] duration-300 w-[90%] h-48 bg-blue-600 rounded-xl">
          <img
            src={imageUrl}
            alt={title}
            title={title}
      ...
      <div className="p-6 z-10 w-full text-center">
        <p className="text-xl font-semibold leading-snug text-blue-600">{title}</p>
      </div>
    </a>
  </div>
);
